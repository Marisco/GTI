...
class _IdentificacaoState extends State<_Identificacao> {
    ...
    PacienteModel pacienteModel = await pacienteBloc
      ...
      setState(() {
        ...
        this._dialogTxtMensagem =
            e.message.toString().toLowerCase().contains("future")
    ...
    return
     ...
     Padding(
            padding: EdgeInsets.only(
                bottom:  MediaQuery.of(context).size.height < 600 ? MediaQuery.of(context).viewInsets.bottom *.5:0) ,
            child: Container(
                      ...
                      Row(children: <Widget>[
                        Expanded(
                            ...
                            child: Text('Documento:',
                                style: AppTextStyle()
                                    .getEstiloTexto(TipoTexto.RADIO))),
                        Radio(
                          value: 0,
                        ...
                        Text('Cartão Sus',
                            style:
                                AppTextStyle().getEstiloTexto(TipoTexto.RADIO)),
                      ]),
                      TextField(
                          ...
                          onSubmitted: (_) {
                            FocusScope.of(context)
                                .requestFocus(focusDataNascimento);
                          },
                          ...
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            fillColor: Color.fromRGBO(41, 84, 142, 1)
                                .withOpacity(0.35),
                          ),
                          style: AppTextStyle()
                              .getEstiloTexto(TipoTexto.PLACEHOLDER),
        ...
        //         dialogTxtTitulo: this._dialogTxtTitulo,
        //         dialogTxtMensagem: this._dialogTxtMensagem,
        //         dialogTxtBtnOK: _dialogState == DialogState.ERROR ? "" : "Sim",
        //         dialogTxtBtnCancel:
        //             _dialogState == DialogState.ERROR ? "" : "Não",
        //         dialogTxtLoading: "Localizando " + this._dsDocumento,
        //         dialogSlideRightBtnCancel:
        //             SlideRightRoute(builder: (_) => Identificacao()),
        //         dialogSlideRightBtnOK: SlideRightRoute(
        //             builder: (_) => Modulos(
        //                 paciente: this.paciente, pacienteId: this.pacienteId)),
        //         dialogColor: Color.fromRGBO(41, 84, 142, 1).withOpacity(0.85));
  }
  ...
  Widget build(BuildContext context) {
    ...
    principal.textoCabecalho = "";
    principal.textoCorpo = _dialogState == DialogState.DISMISSED
        ? "Olá! Seja bem vindo ao Aplicativo Saúde-Serra."
        : "";
    principal.textoRodape = "";
    principal.textoBarraAcao = "";
    principal.textoBarraInferior = "Desenvolvido por GTI-SESA";
    ...
    principal.dialogTxtBtnCancel = _dialogState == DialogState.ERROR ? "" : "Não";
    ...
    principal.dialogTxtLoading = "Localizando " + this._dsDocumento;
    principal.dialogTxtMensagem = _dialogTxtMensagem;
    principal.dialogTxtTitulo = this._dialogTxtTitulo;

    return Container(
        height: MediaQuery.of(context).size.height,
        width: MediaQuery.of(context).size.width,
        child: principal.getPrincipal());
  }
}
