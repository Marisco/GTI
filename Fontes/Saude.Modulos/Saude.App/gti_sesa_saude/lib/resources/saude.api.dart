...
class SaudeApi {
  ...
  Future<PacienteModel> fetchPaciente(
    ...
    final response = await client.post(
        "http://192.168.15.7:3010/saude/getPaciente",
        headers: {
  ...
  Future<UnidadeModel> fetchUnidades() async {
    final response = await client
        .get("http://192.168.15.7:3010/saude/getUnidades", headers: {
      "Accept": "application/json",
      "content-type": "application/json"
    });
    print(response.body.toString());
  ...
  Future<EspecialidadeModel> fetchEspecialidades(
    ...
    final response = await client.post(
        "http://192.168.15.7:3010/saude/getEspecialidades",
        headers: {
          "Accept": "application/json",
          "content-type": "application/json"
        },
  ...
  Future<ConsultaModel> fetchConsultas(String consultaId, String unidadeId,
    ...
    final response = await client.post(
        "http://192.168.15.7:3010/saude/getConsultas",
        headers: {
          "Accept": "application/json",
          "content-type": "application/json"
        },
  ...
  Future<MensagemModel> pushConsulta(
    ...
    final response = await client.post(
        "http://192.168.15.7:3010/saude/postConsulta",
        headers: {
          "Accept": "application/json",
          "content-type": "application/json"
        },
  ...
  Future<InsertModel> pushPaciente(
    ...
    final response = await client.post(
        "http://192.168.15.7:3010/saude/postPaciente",
        headers: {
          "Accept": "application/json",
          "content-type": "application/json"
        },
  ...
  Future<BairroModel> fetchBairros() async {
    final response = await client
        .get("http://192.168.15.7:3010/saude/getBairros", headers: {
      "Accept": "application/json",
      "content-type": "application/json"
    });
    print(response.body.toString());
