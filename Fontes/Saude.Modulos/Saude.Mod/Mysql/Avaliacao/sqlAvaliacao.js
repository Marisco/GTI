const sqlListar =
" (SELECT c.numero,  u.numero AS unidade, u.nome AS nome_unidade, c.data_inicio AS data_atendimento, e.nome AS especialidade, 2 AS tipo_avaliacao,                  "+
...
"     AND c.numero > (SELECT IFNULL(MAX(atendimento),0) FROM avaliacao WHERE tipo_avaliacao = 2)                                                                    "+
"   WHERE p.numero = ?                                                                                                                                              "+
"   ORDER BY data_inicio DESC                                                                                                                                       "+
"   LIMIT 1                                                                                                                                                         "+
"    )                                                                                                                                                              "+
" UNION                                                                                                                                                             "+
" (SELECT  pm.numero, u.numero AS unidade, u.nome AS nome_unidade, pm.data_pedido AS data_atendimento, '' AS especialidade, 3 AS tipo_avaliacao,                    "+
"  (SELECT descricao FROM tipo_avaliacao WHERE numero = 3) AS descricao                                                                                             "+
"    FROM paciente p                                                                                                                                                "+
"    JOIN pedido_medicacao pm ON( pm.paciente = p.numero)                                                                                                          "+
"    JOIN unidade u on ( u.numero = pm.unidade)                                                                                                                     "+
"   WHERE p.numero = ?                                                                                                                                              "+
"     AND pm.numero > (SELECT IFNULL(MAX(atendimento),0) FROM avaliacao WHERE tipo_avaliacao = 3)                                                                   "+
"   ORDER BY data_pedido DESC                                                                                                                                       "+
"   LIMIT 1)                                                                                                                                                        "+
" UNION                                                                                                                                                             "+
" (SELECT r.numero, u.numero AS unidade, u.nome AS nome_unidade, r.data_requisicao AS data_atendimento, '' AS especialidade, 4 AS tipo_avaliacao,                   "+
...
"   WHERE p.numero = ?                                                                                                                                              "+
"     AND r.numero > (SELECT IFNULL(MAX(atendimento),0) FROM avaliacao WHERE tipo_avaliacao = 4)                                                                    "+
...
"    JOIN unidade u on ( u.numero = r.unidade)                                                                                                                      "+
"   WHERE p.numero = ?                                                                                                                                              "+
"     AND r.numero > (SELECT IFNULL(MAX(atendimento),0) FROM avaliacao WHERE tipo_avaliacao = 5)                                                                    "+
"   ORDER BY data_requisicao DESC                                                                                                                                   "+
"   LIMIT 1);                                                                                                                                                       ";

const sqlInserir = 
" INSERT INTO avaliacao (paciente, tipo_avaliacao, data_atendimento, nota, texto, celular ,atendimento) " +    
" VALUES (?, ?, ?, ?, ?, ?, ?); ";
